...
int starsh_ssdata_new_va(STARSH_ssdata **data, const int n, char dtype,
        va_list args);
int starsh_ssdata_new_3d_va(STARSH_ssdata **data, const int n, char dtype,
        va_list args);
...
int starsh_ssdata_new_3d_el(STARSH_ssdata **data, const int n, char dtype, ...);
...
int starsh_ssdata_3d_get_kernel(STARSH_kernel *kernel, const char *type, char dtype);
