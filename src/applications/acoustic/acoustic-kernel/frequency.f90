...
!    open(unit=186,file='stars-h-dev/src/applications/acoustic/acoustic-kernel/geo_node_submarine_nowing_h0.5m.lis')
!    open(unit=187,file='stars-h-dev/src/applications/acoustic/acoustic-kernel/geo_surf_submarine_nowing_h0.5m.lis')
!    call incurvefile_ideas_sub
!    print*,"I am on submarine:"
!    open(unit=111,file='stars-h-dev/src/applications/acoustic/acoustic-kernel/geo_mesh_Submarine_10818.inp')
!    call incurvefile_ideas
else
